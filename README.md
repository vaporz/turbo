 ...
 * [PreProcessor and PostProcessor](#preprocessor_and_postprocessor): customizable url-grpc mapping process.
...
+	return &proto.EatAppleResponse{Message: "Good taste! Apple num=" + req.Num}, nil
+}
```
