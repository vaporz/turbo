...
func (*CommonValues) Descriptor() ([]byte, []int) {
	return fileDescriptor_d8a4e87e678c5ced, []int{0}
}

func (m *CommonValues) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_CommonValues.Unmarshal(m, b)
}
func (m *CommonValues) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_CommonValues.Marshal(b, m, deterministic)
}
func (m *CommonValues) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CommonValues.Merge(m, src)
}
func (m *CommonValues) XXX_Size() int {
	return xxx_messageInfo_CommonValues.Size(m)
}
func (m *CommonValues) XXX_DiscardUnknown() {
	xxx_messageInfo_CommonValues.DiscardUnknown(m)
}

var xxx_messageInfo_CommonValues proto.InternalMessageInfo
...
func init() {
	proto.RegisterType((*CommonValues)(nil), "proto.CommonValues")
}
