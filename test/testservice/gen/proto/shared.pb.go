...
func (x *CommonValues) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CommonValues) ProtoMessage() {}

func (x *CommonValues) ProtoReflect() protoreflect.Message {
	mi := &file_shared_proto_msgTypes[0]
...
// Deprecated: Use CommonValues.ProtoReflect.Descriptor instead.
func (*CommonValues) Descriptor() ([]byte, []int) {
	return file_shared_proto_rawDescGZIP(), []int{0}
}

func (x *CommonValues) GetSomeId() int64 {
	if x != nil {
		return x.SomeId
	}
	return 0
...
var file_shared_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x26, 0x0a, 0x0c, 0x43, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x56,
	0x61, 0x6c, 0x75, 0x65, 0x73, 0x12, 0x16, 0x0a, 0x06, 0x73, 0x6f, 0x6d, 0x65, 0x49, 0x64, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x06, 0x73, 0x6f, 0x6d, 0x65, 0x49, 0x64, 0x42, 0x09, 0x5a,
...
var file_shared_proto_goTypes = []interface{}{
	(*CommonValues)(nil), // 0: proto.CommonValues
}
